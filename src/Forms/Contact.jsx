...
function Contact() {
    ...
    return (
        <>
            <div style={{ backgroundImage: `linear-gradient(rgba(0,0,0,0.7),rgba(0,0,0,0.7)),url(${imagebg})`, backgroundSize: 'cover', }} className=" contactdesign h-auto  flex-col md:flex-row flex items-center justify-center px-4 py-12">
                ...
                <div className="w-[100%] max-w-3xl  shadow-xl rounded-3xl relative  bg-[ #0A0125]/80 backdrop-blur-md p-8">
                 <div className='absolute top-[2%] right-[2%] text-4xl hover:rounded-[50%] dark:text-white hover:bg-green-700 px-2 py-2 hover:text-white transition-all .5s '><Link to='/'><FaXmark /></Link></div>
                    ...
                    {submitted ? (
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6 ">
                            ...
                            <div>
                                <label className="block mb-1 text-sm font-medium text-white">Service</label>
                                <input
                                    type="text"
                                    name="service"
                                    onChange={handleChange}
                                    ...
                                    className="w-full px-4 placeholder-gray-700 py-2 border text-white border-gray-300 rounded-md bg-transparent focus:bg-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-400"
                                />
                            </div>
                            <div>
                                ...
                                <input
                                    ...
                                    onChange={handleChange}
                                    required
                                    className="w-full px-4 py-2 border border-gray-300 rounded-md bg-transparent text-white focus:bg-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-400"
                                />
                            </div>
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    required
                                    rows="5"
                                    className="w-full px-4 py-2 border border-gray-300 text-white rounded-md bg-transparent focus:bg-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-400"
                                ></textarea>
                            </div>
